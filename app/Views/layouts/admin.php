...
<head>
    ...
    <title><?= esc($title ?? 'Laundryku Admin') ?></title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="sidebar w-64 min-h-screen p-6 expanded" id="sidebar">
            ...
            <nav class="space-y-1">
                ...
                ?>
                <a href="/admin/dashboard" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/dashboard') ? 'active' : '' ?>">
                ...
                <a href="/admin/orders" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/orders') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/admin/services" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/services') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/admin/customers" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/customers') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/admin/users" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/users') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 10-4-4 4 4 0 004 4zm6-4a4 4 0 11-4-4"></path>
                        </svg>
                        <span class="sidebar-text">User & Role</span>
                    </span>
                </a>
                <a href="/admin/promotions" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/promotions') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/admin/faqs" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/faqs') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/admin/reports" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/reports') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/admin/settings" class="sidebar-link block px-4 py-3 rounded-lg <?= $isActive('admin/settings') ? 'active' : '' ?>">
                    <span class="flex items-center">
                        <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
